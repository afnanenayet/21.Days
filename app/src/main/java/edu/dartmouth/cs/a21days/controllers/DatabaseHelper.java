...
public class DatabaseHelper {
     ...
     */
    private DatabaseHelper(String userId) {
    ...
    /**
     * Gets the singleton instance of the DatabaseHelper and switches userId
     * @param userId The identifier string for the user
     * @return An instance of the DatabaseHelper
     */
    public static DatabaseHelper getInstance(String userId) {

        // If class hasn't been initialized, then initialize class
        if (instance == null) {
            instance = new DatabaseHelper(userId);
        }
